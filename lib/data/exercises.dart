  ...
  Exercise(
    ...
    steps: const [
      ExerciseStep(
        title: 'Προετοιμασία',
        body:
            'Κάθισε αναπαυτικά με την πλάτη ίσια. Άφησε τους ώμους να χαλαρώσουν. Θα κάνουμε 4 κύκλους αναπνοής.',
      ),
      ExerciseStep(
        title: 'Ακολούθησε τον ρυθμό',
        body: 'Εισπνοή 4 δευτ. → Κράτα 7 δευτ. → Εκπνοή 8 δευτ.',
        hasBreathAnimation: true,
        breathDurationSeconds: 19,
      ),
      ExerciseStep(
        title: 'Ολοκληρώθηκε!',
        body:
